...
<head>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mb.YTPlayer/3.0.20/jquery.mb.YTPlayer.min.js"></script>
...
<body class="slides stack smooth fast smoothScroll animated">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display:none">
    ...
    <symbol id="login" viewBox="0 0 22 22">
      <path
        d="M13 2c0 .6.4 1 1 1h6v16h-6c-.6 0-1 .4-1 1s.4 1 1 1h6c1.1 0 2-.9 2-2v-16c0-1.1-.9-2-2-2h-6c-.6 0-1 .4-1 1zm-6.5 3.5c0 .3.1.5.3.7l3.8 3.8h-9.6c-.6 0-1 .4-1 1s.4 1 1 1h9.6l-3.8 3.8c-.2.2-.3.5-.3.7s.1.5.3.7c.4.4 1 .4 1.4 0l5.5-5.5c.1-.1.2-.2.2-.3.1-.2.1-.5 0-.8l-.2-.3-5.5-5.5c-.4-.4-1-.4-1.4 0-.2.2-.3.4-.3.7z" />
    </symbol>
  ...
  <nav class="panel top">
    <div class="sections">
      <div class="left"><a href="#" title="Rucept"><img id="chng" src="white_logo.png" /></a></div>
  ...
  <nav class="sidebar deepPurple" data-sidebar-id="1">
    ...
    <div class="content">
      <a href="#" title="Rucept"
        style="display:block !important; text-align:left !important; width:100% !important;"><img src="white_logo.png"
          style="display:block !important; width:210px !important; height:auto !important;" /></a>

      <ul class="subMenu">
        <li><a href="#"> </a></li>
        <li><a href="#">Merchandise Now</a></li>
        <li><a href="#">How Rucept Works</a></li>
        <li><a href="#">Instant Revenue</a></li>
  ...
  <section class="slide fade kenBurns">
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-10-12">
            <h1 class="huge ae-1">Merchandising Unbound</h1>
            <div class="ae-2">
              <p class="hero">Rucept is a zero hassle end to end merchandising solution for creators, content
                aggregators, and celebrities</p>
            </div>
            <a class="button crop pink ae-3">Merchandise Now</a>
            <div class="button play white small popupTrigger toCenter ae-6 fromCenter block margin-top-5"
              data-popup-id="21-0">
              <svg>
    ...
    <div class="background" id="player"
      data-property="{videoURL:'https://youtu.be/9uxhT1izgJE',containment:'self',startAt:0,mute:false,autoPlay:true,loop:true,opacity:1,printUrl:false}">
    </div>
  </section>

  <!-- Popup Video -->
  <div class="popup autoplay" data-popup-id="21-0">
    <div class="close"><svg>
        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#close"></use>
      </svg></div>
    <div class="content">
      ...
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-10-12 toCenter">
            <h1 class="ae-1">How Rucept Works</h1>
            <div class="ae-2">
              <p>Our creative services and integrated platform ensure high quality assets turn into hundreds of products
                which are sold all over the world in an inventory free made on demand model</p>
            </div>
          </div>
          <div class="fix-12-12">
            <ul class="grid grid-74 later equal left margin-top-5">
              <li class="col-3-12 ae-3 fromCenter">
                <a href="#" class="box-74">
                  <div class="thumbnail-74">
                    <img src="assets/img/inner-74-1.jpg" class="wide" alt="Thumbnail" />
                  </div>
                  <div class="name-74 equalElement table wide">
                    <div class="cell">
                      <h3 class="big">Content Creation</h3>
                      <div class="description-74">We create original content unique to your brand aesthetic that speaks
              ...
              <li class="col-3-12 ae-4 fromCenter">
                <a href="#" class="box-74">
                  <div class="thumbnail-74">
                    <img src="assets/img/inner-74-2.jpg" class="wide" alt="Thumbnail" />
                  </div>
                  <div class="name-74 equalElement table wide">
                    <div class="cell">
                      <h3 class="big">Product Catalogs</h3>
                      <div class="description-74">All creative assets made by us or provided by you are placed on
                        hundreds of products, creating digital catalogs</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="col-3-12 ae-5 fromCenter">
                <a href="#" class="box-74">
                  <div class="thumbnail-74">
                    <img src="assets/img/inner-74-3.jpg" class="wide" alt="Thumbnail" />
                  </div>
                  <div class="name-74 equalElement table wide">
                    <div class="cell">
                      <h3 class="big">Multichannel Listing</h3>
                      <div class="description-74">Our API integrated and manual listing tools bring your products to
                        dozens of sites worldwide</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="col-3-12 ae-5 fromCenter">
                <a href="#" class="box-74">
                  <div class="thumbnail-74">
                    <img src="assets/img/inner-74-4.jpg" class="wide" alt="Thumbnail" />
                  </div>
                  <div class="name-74 equalElement table wide">
                    <div class="cell">
                      <h3 class="big">Worldwide Fulfillment</h3>
                      <div class="description-74">Our AI automatically finds manufacturer best suited to deliver
                        products made on demand post customer purchase</div>
                    </div>
                  </div>
                </a>
              </li>
          ...
          <div class="fix-12-12">
            <ul class="flex verticalCenter">
              <li class="col-5-12 ae-1 cell-29">
                <img src="assets/img/iphone-7.png" class="iphone-29" alt="iPhone Thumbnail" data-action="zoom" />
              </li>
              <li class="col-7-12 left">
                <h1 class="ae-1 fromLeft">Instant Revenue</h1>
                <div class="ae-2 fromLeft">
                  <p>Eliminate long merchandising setup cycles times with our platform. Start building catalogs, listing
                    and generating revenue right away, while retainin rights to your products</p>
                </div>
                <a class="button round pink ae-3 fromCenter crop">Start free trial</a>
              </li>
            </ul>
          </div>
  ...
  <section class="slide fade kenBurns">
        ...
        <div class="wrap">
          ...
          <div class="fix-12-12">
            <ul class="grid fixedSpaces equal fromCenter">
              <h1>Rucept Is For Creators</h1>
            </ul>
            <ul class="grid fixedSpaces equal fromCenter">
              <li class="col-4-12">
                <a href="#" class="box-70 ae-1" style="background-color:#BDD6D3;">
                  <div class="thumbnail-70">
                    <img class="wide" src="assets/img/70-grid-1.png" alt="Image">
                  </div>
                  <div class="info-70">
                    <div class="category-70">100% Creative</div>
                    <h3 class="big title-70">For Artists</h3>
                    <p class="small equalElement">Retain creative control by designing your own products and catalogs
                      with existing assets</p>
                    <div class="button pink wide crop">Learn More</div>
                  </div>
                </a>
              </li>
              <li class="col-4-12">
                <a href="#" class="box-70 ae-2" style="background-color:#C3CCDD;">
                  <div class="thumbnail-70">
                    <img class="wide" src="assets/img/70-grid-2.png" alt="Image">
                  </div>
                  <div class="info-70">
                    <div class="category-70">100% Business</div>
                    <h3 class="big title-70">For Content Sites</h3>
                    <p class="small equalElement">Open up new revenue streams for your high traffic content site with
                      owner or affiliate model</p>
                    <div class="button pink wide crop">Learn More</div>
                  </div>
                </a>
              </li>
              <li class="col-4-12">
                <a href="#" class="box-70 ae-3" style="background-color:#D9D5C5;">
                  <div class="thumbnail-70">
                    <img class="wide" src="assets/img/70-grid-3.png" alt="Image">
                  </div>
                  <div class="info-70">
                    <div class="category-70">100% Exposure</div>
                    <h3 class="big title-70">For Celebrities</h3>
                    <p class="small equalElement">Make the most of your media footprint by introducing products designed
                      for you to your fan base</p>
                    <div class="button pink wide crop">Learn More</div>
                  </div>
                </a>
              </li>
    ...
    <div class="background" style="background-image:url(assets/img/img-70.jpg)"></div>
  </section>
    ...
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-10-12 toCenter">
            <h1 class="ae-1">We Make All Products</h1>
            <div class="ae-2">
              <p>Rucept enables you to access the worlds biggest made to order product catalog exclusively through our
                platform</p>
            </div>
          </div>
          <div class="fix-12-12">
            <ul class="grid grid-69 later equal equalMobile popupTrigger controller" data-popup-id="69-4"
              data-slider-id="69-4">
              <li class="col-4-12">
                <a href="#" class="box-69 ae-3 equalElement selected" style="background-image:url(gif/200w_d.gif);">
                  <div class="table cell-69 equalElement">
                    <div class="cell">
                      <div class="category-69">34 Products</div>
                      <div class="title-69">Direct to Garment Prints</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="col-4-12">
                <a href="#" class="box-69 ae-4 equalElement" style="background-image:url(gif/200w_d_1.gif);">
                  <div class="table cell-69 equalElement">
                    <div class="cell">
                      <div class="category-69">22 Products</div>
                      <div class="title-69">Sublimation Prints</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="col-4-12">
                <a href="#" class="box-69 ae-5 equalElement" style="background-image:url(gif/200w_d_2.gif);">
                  <div class="table cell-69 equalElement">
                    <div class="cell">
                      <div class="category-69">63 Products</div>
                      <div class="title-69">Fashion Accessories</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="col-4-12">
                <a href="#" class="box-69 ae-6 equalElement" style="background-image:url(gif/200w_d_3.gif);">
                  <div class="table cell-69 equalElement">
                    <div class="cell">
                      <div class="category-69">51 Products</div>
                      <div class="title-69">Home Decor</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="col-4-12">
                <a href="#" class="box-69 ae-7 equalElement" style="background-image:url(gif/200w_d_4.gif);">
                  <div class="table cell-69 equalElement">
                    <div class="cell">
                      <div class="category-69">29 Products</div>
                      <div class="title-69">Footwear</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="col-4-12">
                <a href="#" class="box-69 ae-8 equalElement" style="background-image:url(gif/200w_d_5.gif);">
                  <div class="table cell-69 equalElement">
                    <div class="cell">
                      <div class="category-69">42 Products</div>
                      <div class="title-69">Paper and Stationery</div>
                    </div>
                  </div>
                </a>
              </li>
  ...
  <!-- Popup Gallery -->
  <div class="popup animated" data-popup-id="69-4">
    <div class="close"><svg>
        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#close"></use>
      </svg></div>
    <div class="content">
      <div class="container">
        <div class="wrap spaces">
          ...
          <ul class="slider inlineBlock clickable popupContent ae-1 fromCenter disableSelect" data-slider-id="69-4"
      ...
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-10-12 toCenter">
            ...
            <div class="ae-2">
              <p>List catalogs of products on <a href="https://rucept.net/"> over 30 </a> major global eCommerce
                marketplace for unparalleled and cost effective multichannel selling integrations</p>
            </div>
          </div>
          <div class="fix-12-12">
            ...
            <ul class="grid grid-68 equal later">
              <li class="col-2-12">
                <div class="table wide equalElement ae-3">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/amazon.jpg" alt="BBC" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-4">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/amazon.jpg" alt="Google" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-5">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/Rakuten_logo.svg.png" alt="Apple" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-6">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/logo-lazada1.png" alt="Canon" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-7">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/Paytm_logo.png" alt="Nike" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-8">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/youtube_PNG21.png" alt="Green Peace" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-3">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/New_Walmart_Logo.png" alt="Facebook" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-4">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/lazada-logos-05-1.png" alt="Audi" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-5">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/acouk_logo_rgb_large.jpg" alt="Warner Bros" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-6">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/taobao.png" alt="Microsoft" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-7">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/instagram-logo-transparent_258555.jpg" alt="Coca Cola" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-8">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/2000px-EBay_logo.svg.png" alt="Reebok" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-3">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/nLogo.png" alt="Adidas" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-4">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/logo-amazon-fr.png" alt="Vimeo" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-5">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/fnac-logo.png" alt="NBC" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-6">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/facebook-logo-vector-400x400.png" alt="Sony" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-7">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/Etsy_logo.png" alt="PlayStation" />
                  </div>
                </div>
              </li>
              <li class="col-2-12">
                <div class="table wide equalElement ae-8">
                  <div class="cell">
                    <img width="124" src="eCommerceLogos/Jabong_logo_logotype.png" alt="National Geographic" />
                  </div>
                </div>
              </li>
            </ul>
  ...
  <section class="slide fade kenBurns">
    <div class="content">
      <div class="container">
        <div class="wrap top">
          ...
          <div class="fix-10-12 toCenter">
            <img class="margin-bottom-1 ae-1 fromCenter" src="assets/img/icon-36.png" alt="App Icon" width="70" />
            <div class="ae-2">
              <p class="hero">We Manufacture Everywhere</p>
            </div>
            <h1 class="ae-3">Over Two Dozen Factories</h1>
            <div class="ae-4">
              <p>Our AI combs through product pricing and shipping data to determine the fastest, cheapest way to make
                and ship anywhere </p>
            </div>
          </div>
    ...
    <div class="background" style="background-image:url(assets/img/img-36.jpg)"></div>
  </section>
    ...
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-12-12">
            <h1 class="ae-1">Flexible Pricing</h1>
            <ul class="grid noSpaces equal grid-85 ae-2 fromCenter dicoder-pircing">
              <li class="col-3-12 tint-85 ae-3" id="price-di-one">
                <h3 class="small uppercase ae-4">New Content Design</h3>
                <div class="price-85 ae-5"><span class="currency-85">$</span>25</div>
                <div class="ae-5">
                  <div class="h4 uppercase bold small opacity-6 margin-top-2" style="min-height: 34px">Per image created
                  </div>
                </div>
                <div class="features-85 equalElement ae-6">
                  <ul>
                    <li><strong>Made for product masking</strong></li>
                    <li><strong>Pattern, print, or design</strong></li>
                    <li class="opacity-7">Bulk pricing for set of 8</li>
                    <li class="opacity-7">Made with data, client input</li>
                  </ul>
                </div>
                <a href="#" class="button teal wide cropBottom ae-7">Design My Content </a>
              </li>
              <li class="col-3-12 ae-4" id="price-di-two">
                <h3 class="small uppercase ae-5">Product Creation</h3>
                <div class="price-85 ae-6"><span class="currency-85">$</span>4</div>
                <div class="ae-6">
                  <div class="h4 uppercase bold small opacity-6 margin-top-2" style="min-height: 34px">Price per 10 SKUs
                  </div>
                </div>
                <div class="features-85 equalElement ae-7">
                  <ul>
                    <li><strong>250+ photorealistic products</strong></li>
                    <li><strong>Mock ups by virtual assistant</strong></li>
                    <li class="opacity-7">Amazon compliant products</li>
                    <li class="opacity-7">Minimum 100 SKUs</li>
                  </ul>
                </div>
                <a href="#" class="button pink wide cropBottom ae-8">Make Products For Me</a>
              </li>
              <li class="col-3-12 ae-5" id="price-di-three">
                <h3 class="small uppercase ae-6">Multichannel Listing</h3>
                <div class="price-85 ae-7"><span class="currency-85">$</span>50</div>
                <div class="ae-7">
                  <div class="h4 uppercase bold small opacity-6 margin-top-2" style="min-height: 34px">Price per channel
                  </div>
                </div>
                <div class="features-85 equalElement ae-8">
                  <ul>
                    <li><strong>Unlimited listings</strong></li>
                    <li><strong>Includes seller fees</strong></li>
                    <li class="opacity-7">100% Managed by Rucept</li>
                    <li class="opacity-7">Ebay and Etsy priced differently</li>
                  </ul>
                </div>
                <a href="#" class="button pink wide cropBottom ae-9">List Worldwide</a>
              </li>
              <li class="col-3-12 ae-6" id="price-di-four">
                <h3 class="small uppercase ae-7">Global Fulfillment</h3>
                <div class="price-85 ae-8">10<span class="currency-85 currency-85-dicoder">%</span></div>
                <div class="ae-8">
                  <div class="h4 uppercase bold small opacity-6 margin-top-2" style="min-height: 34px">Of Net Profit
                  </div>
                </div>
                <div class="features-85 equalElement ae-9">
                  <ul>
                    <li><strong>On demand manufacturing</strong></li>
                    <li><strong>Low prices = high margins</strong><span class="helpBubble">
                        <div class="helpMessage">The most innovative designers <strong>consciously</strong> reject the
                          standard and cultivate.</div>
                      </span></li>
                    <li class="opacity-7">Global shipping and returns</li>
                    <li class="opacity-7">24/7 Customer Support</li>
                  </ul>
                </div>
                <a href="#" class="button pink wide cropBottom ae-10">Manage my Fulfillment</a>
              </li>
            </ul>
          </div>
    ...
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-12-12">
            <div class="fix-10-12 toCenter">
              <h1 class="ae-1">Frequently Asked Questions</h1>
              <div class="ae-2">
                <p>Ecommerce is hard. Rucept is easy. See how below. </p>
              </div>
            </div>
            <ul class="flex left margin-top-6">
              <li class="col-6-12 margin-bottom-1 ae-3">
                <h3 class="sourceSans">How are you different from Shopify, Volusion or Woo Commerce?</h3>
                <p class="small">3rd party ecommerce solutions only provide one step of the puzzle which is online
                  selling.Rucept connects with fulfilment partners and handles pricing, upload and inventory management
                  on several sites.</p>
              </li>
              <li class="col-6-12 margin-bottom-1 ae-4">
                <h3 class="sourceSans">How much do products cost? How do I set markup on products?</h3>
                <p class="small">Our base cost is lower than Zazzle,Shutterfly, and Cafepress and most markups are
                  determined by our dynamic pricing method which finds the best price to ship the most products and
                  optimize earnings.</p>
              </li>
              <li class="col-6-12 margin-bottom-1 ae-5">
                <h3 class="sourceSans">Am I selling art to you?</h3>
                <p class="small">No, your art is yours, even the one we create for you. Our licensing agreement allows
                  for us to create products to list on your site and on marketplaces. Rucept owns no copyright.</p>
              </li>
              <li class="col-6-12 margin-bottom-1 ae-6">
                <h3 class="sourceSans">How and when do I get paid?</h3>
                <p class="small">When you sign up with fulfilled by Rucept, it will ask you for payout details over bank
                  account or Paypal. Payouts are made monthly after adjusting for local taxes and returns.</p>
              </li>
            </ul>
            <a href="#" class="button pink crop margin-top-4 ae-7">More questions and answers</a>
          </div>
  ...
  <section class="slide fade kenBurns">
      ...
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-10-12 center">
            <div class="ae-1">
              <p class="hero opaque">"We've taken our historical images, concept art and storyboards from hangings on
                the studio wall to fully realized products available everywhere with Rucept. Most importantly, it brings
                us money to support the film."</p>
            </div>

            <div class="fix-4-12">
              <a href="#" class="author block">
                <div class="ae-2 fromCenter"><img width="60" class="avatar-41 ae-2 fromCenter"
                    src="assets/img/avatar-1.jpg" alt="Paul Rand" /></div>
                <div class="ae-3">
                  <h3 class="margin-bottom-0">Sean Graham</h3>
                </div>
                <div class="ae-4">
                  <p class="small">Director, Ramayan Film</p>
                </div>
              </a>
            </div>
          </div>
    ...
    <div class="background" id="player1"
      data-property="{videoURL:'https://youtu.be/9uxhT1izgJE',containment:'self',startAt:0,mute:false,autoPlay:true,loop:true,opacity:1,printUrl:false}">
    </div>
  </section>
    ...
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="ae-2">
            <p>Message us here for product questions, employment opportunities, investor interest and press</p>
          </div>
          <div class="fix-5-12 margin-top-6">
            <div class="pad shadow selected ae-3">
              <form action="ajax-email.php" id="contact-form" method="post" class="wide center" data-ajax-form="true">
                ...
                <textarea class="left ae-9" id="message55" type="text" name="message" placeholder="Message"
                  required></textarea>
                <input class="button wide pink ae-10 margin-top-2 cropBottom" type="submit" name="submit"
                  value="Send message" data-success-text="Done!" data-success-class="green" />
              </form>
            </div>
          </div>
  ...
  <!-- Preloader -->
  <div class="loadingIcon"><svg class="loading-icon" id="loading-circle" viewBox="0 0 18 18">
  ...
  <script defer>
    ...
    jQuery(function () {
      ...
      jQuery("#player1").delay(500).mb_YTPlayer();
